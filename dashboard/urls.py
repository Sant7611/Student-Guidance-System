...
from .views import student_dashboard_view, mentor_dashboard_view, counselor_dashboard_view, admin_dashboard_view
...
urlpatterns=[
    ...
    path('dashboard/admin/', admin_dashboard_view.AdminDashboardView.as_view(), name='admin_dashboard')
]